...
function applyBackgrounds(){
  const img = config.welcomeImage ? `url(${config.welcomeImage})` : "";
  if (homeHeroBg) homeHeroBg.style.backgroundImage = img;
  if (heroPreviewBg) heroPreviewBg.style.backgroundImage = img;
  if (mainBg) mainBg.style.backgroundImage = img;
}
